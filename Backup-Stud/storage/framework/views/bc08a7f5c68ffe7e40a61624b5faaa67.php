                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="list-group-item">
                            <div class="row list-display" style="align-items: center; justify-content:space-around">
                                <div class="col-3 list-details" style="text-align: center"><?php echo e($student->name); ?></div>
                                <div class="col-5 list-details" style="text-align: center"><?php echo e($student->email); ?></div>
                                <div class="col-3 list-details" style="text-align: center"><?php echo e($student->joined_date); ?>
...
<?php /**PATH C:\xampp\htdocs\NewLaravel\StudentForm\resources\views/Student.blade.php ENDPATH**/ ?>